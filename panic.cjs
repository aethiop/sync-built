		...
		it(
			...
			async function () {
				...
				await page.waitForFunction(
					'document.querySelectorAll(".btn.btn-text.justify-center")[2]'
				);
				await page.evaluate(() => {
					let elements = document.querySelectorAll(
						".btn.btn-text.justify-center"
					);
					elements[2].click();
				});
				...
				await page.$$eval(".btn.btn-primary", (buttons) =>
					buttons[0].click()
				);
				...
				await page.waitForFunction(
					'document.querySelectorAll(".btn.btn-text")[3]'
				);

				// // Download button clicked
				console.log("Download Clicked");
				await page.evaluate(() => {
					let elements = document.querySelectorAll(".btn.btn-text");
